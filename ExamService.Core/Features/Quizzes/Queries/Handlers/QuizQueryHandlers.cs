                              ...
                              , IRequestHandler<GetIncomingCourseQuizzesQueryModel, Response<List<GetIncomingCourseQuizzesQueryResponse>>>
{
    ...
    #region Constructors
    public QuizQueryHandlers(IStudentQuizzesService studentQuizzesService, IQuizService quizService, IMapper mapper)
    {
    ...
    {
        var inquiredQuiz = await _studentQuizzesService.ViewQuizDetailsAsync(request.quizId, request.studentId);
